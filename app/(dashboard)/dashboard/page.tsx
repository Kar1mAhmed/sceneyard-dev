    ...
    <div className="space-y-8">
      ...
      <div className="bg-gradient-to-r from-primary/20 to-secondary-purple/20 rounded-2xl p-8 border border-primary/20">
        ...
        <p className="text-brand-white/70 text-lg">
          Manage your templates, credits, and account settings
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-brand-white/5 backdrop-blur-sm border border-brand-white/10 rounded-xl p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-brand-white/70 text-sm font-medium">Credits Balance</h3>
          ...
          <p className="text-3xl font-bold text-brand-white">0</p>
          <p className="text-brand-white/50 text-sm mt-1">Available credits</p>
        </div>

        <div className="bg-brand-white/5 backdrop-blur-sm border border-brand-white/10 rounded-xl p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-brand-white/70 text-sm font-medium">Downloads</h3>
            <svg className="w-6 h-6 text-secondary-cyan" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M9 19l3 3m0 0l3-3m-3 3V10" />
            </svg>
          </div>
          <p className="text-3xl font-bold text-brand-white">0</p>
          <p className="text-brand-white/50 text-sm mt-1">Total downloads</p>
        </div>

        <div className="bg-brand-white/5 backdrop-blur-sm border border-brand-white/10 rounded-xl p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-brand-white/70 text-sm font-medium">Subscription</h3>
            <svg className="w-6 h-6 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z" />
            </svg>
          </div>
          <p className="text-3xl font-bold text-brand-white">Free</p>
          <p className="text-brand-white/50 text-sm mt-1">Current plan</p>
        </div>
      </div>
