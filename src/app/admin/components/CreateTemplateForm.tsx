...
export function CreateTemplateForm({ categories }: CreateTemplateFormProps) {
    ...
    async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
        ...
        try {
            ...
            const uploadResults = await uploadTemplateAssets(previewVideo, downloadFile, (stage, progress) => {
                setUploadProgress({ stage, progress });
            });

            // 2. Create template record in DB
            const response = await fetch('/api/templates/create', {
                ...
                body: JSON.stringify({
                    ...
                    description,
                    credits_cost,
                    preview_asset_id: uploadResults.previewAssetId,
                    preview_thumbnail_id: uploadResults.thumbnailAssetId,
                    file_asset_id: uploadResults.downloadAssetId,
                    orientation,
